          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="index.html" class="menu-link">
                ...
                <div data-i18n="Analytics">Varian</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="tables-basic.html" class="menu-link">
                ...
                <div data-i18n="Tables">Slider</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="tables-basic.html" class="menu-link">
                ...
                <div data-i18n="Tables">Promo</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Form Layouts">Link</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form-layouts-vertical.html" class="menu-link">
                    <div data-i18n="Vertical Form">Social</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="form-layouts-horizontal.html" class="menu-link">
                    <div data-i18n="Horizontal Form">Map</div>
                  </a>
                </li>
              </ul>
            </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Saya</span>
...
<?php /**PATH C:\xampp\htdocs\katalog_laravel\resources\views/layouts/master.blade.php ENDPATH**/ ?>